...
We went to bike data section and through right click on the link which leads on downloading the .csv file, we copied the link to use it for downloading the data through R.       
